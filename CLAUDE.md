...
- `const SERVICES =` — 5 services (car / hotel / flight / transfer / activity) with per-language names, descriptions, and discount badge text. Drives the services grid, marquee, form checkboxes, quote message, and chatbot context.
